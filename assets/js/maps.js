    ...
    marker.bindPopup(
        '<div class="map__popup__wrapper" style="display:flex;flex-direction: row-reverse; align-items: center;">'+
            '<div class="map__popup__description">'+
                ...
                '</div>'+
            '</div>'+
            '<div class="map__popup__image"><img height="50px" width="50px" src="./assets/img/fellow/{{item.img}}" style="border-radius: 7px; border: 2px solid black; margin-right: 10px;"/></div>'+
        '</div>'
        );
{% endfor %}